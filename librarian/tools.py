        ...
        types.FunctionDeclaration(
            ...
            parameters=types.Schema(
                ...
                properties={
                    ...
                    "user_friendly": types.Schema(type="INTEGER", description="호감/우정 변화량 (예: +2, -1)"),
                    "user_lovely": types.Schema(type="INTEGER", description="애정/설렘 변화량 (예: +1, -2)"),
                    "user_trust": types.Schema(type="INTEGER", description="신뢰 변화량 (예: +1, -3)"),
                    "self_mood": types.Schema(type="INTEGER", description="내 기분 변화량 (예: +3, -2)"),
                    "self_tired": types.Schema(type="INTEGER", description="피로 변화량 (예: +1, -1)"),
                    "server_vibe": types.Schema(type="INTEGER", description="서버 분위기 변화량 (예: +2, -1)"),
