...
L1 Perception (temp 0.3, 채널별 히스토리 5건)
  맥락 관찰 + 정보 수집. 감정 수치를 자연어로 해석. 이전 소견 최우선 전달.
  유저/채널 요약(DB)을 읽어서 장기 맥락 반영.
  도구: search, web_search, recognize_media, recognize_link
      |
L2 Functioning (temp 0.5, 히스토리 없음)
  실행 전담. L1 결과(검색/인식 포함) 참조. 1회 호출.
  도구: deliver, attach
      |
...
L4 Postprocess (temp 0.1, 히스토리 없음)
  시스템 흔적 교체, 멘션/채널/역할/이모지 교정, 대사 보완.
  도구 없음.
      |
