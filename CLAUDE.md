...
L4 Postprocess (temp 0.1, 히스토리 없음)
  ...
  도구 없음.
      |
L5 Evaluation (temp 0.3, 단일 히스토리 5건, 큐 워커)
...
전 레이어 Gemini 3.1-flash-lite. config.json에서 레이어별 모델 개별 지정 가능 (model_l2, model_l4).
